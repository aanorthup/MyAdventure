...
class Pathing {
    ...
    let choice = [
        ...
        //10
        Choice("You find a person sinking into quicksand and help him. He smiles, and offers to help you. On your walk back, you find out he's the king of this land! He even knows what magic sent you here, and sends you home in time for dinner. Good job!", "Restart", "Restart"),
        //11
        Choice("You run away - but feel a sharp stab in your back. The poison spreads before you can see what got you. You never get up again.", "Restart", "Restart"),
        //12
        Choice("You turn around and face a giant serpent. It retreats in surprise at being faced. A soldier sees and comes running to you. By dumb luck, you become a hero in this world. Unfortunately, you don't find your way home.", "Restart", "Restart"),
        //13
        Choice("The dragon smiles a toothy grin. 'It's been a long time since anyone was polite in this room.' You didn't find your way home, but you made a powerful friend. That's something.", "Restart", "Restart"),
        //14
